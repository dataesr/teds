...
both IPCC and IPBES reports. Philippe Ciais is particularly active and
cited in both reports.
...
1.9\% of the publications in scanR seem to focus on topics related to
the IPCC's work. Of these, 0.4\% are related to science, 1.2\% to
adaptation, and 0.3\% to mitigation. But the proportion of publications
addressing topics similar to those covered by the IPCC seems to be
